...
@Component({
  selector: 'nextdev-comp-monitor-charts-deployment',
  templateUrl: './monitor-charts-deployment.component.html',
  styleUrls: ['./monitor-charts-deployment.component.css']
})
export class MonitorChartsDeploymentComponent implements OnInit {
