...
@Component({
  selector: 'nextdev-comp-monitor-project-build-charts',
  templateUrl: './monitor-project-build-charts.component.html',
  styleUrls: ['./monitor-project-build-charts.component.css']
})
export class MonitorProjectBuildChartComponent implements OnInit {
